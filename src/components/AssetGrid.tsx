...
import { Search, Package, Calendar, DollarSign, Shield, AlertTriangle } from "lucide-react";
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-medium">{formatCurrency(assets.reduce((sum, asset) => sum + asset.value, 0))}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-medium">{assets.filter(asset => asset.status === "maintenance").length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                <CardHeader className="p-4 pb-2">
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    {warrantyStatus && WarrantyIcon && (
                      <WarrantyIcon className={`h-4 w-4 ${warrantyStatus.color} ml-2 flex-shrink-0`} />
                    )}
                  </div>
                </CardHeader>
                ...
                <CardContent className="p-4 pt-0">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm">{asset.documents.length}</span>
                    </div>
